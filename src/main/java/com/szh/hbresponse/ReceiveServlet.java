...
public class ReceiveServlet {
    ...
    public static Set<String> getAllMObile() {
        ...
        String path = "/home/zhihaosong/workspace/com-szh-demo/src/com/szh/hbresponse/initdata.txt";
    ...
    public static Map<String, String> getAllResponse() {
        ...
        String path = "main/java/com/szh/hbresponse/smsmo.txt";
        File file = new File(path);
        BufferedReader reader = null;
        try {
            reader = new BufferedReader(new FileReader(file));
    ...
    public static void wirteFile(String result) {
        File wirtefile = new File("/home/zhihaosong/workspace/com-szh-demo/src/main.java.com.szh.hbresponse/smsResponseResult.txt");
        try {
            if (!wirtefile.exists()) {
